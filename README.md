...
This repository contains two simple Java console applications for beginner-level practice.

---

## 1. Simple Calculator

A basic console-based calculator that performs four operations: addition, subtraction, multiplication, and division.
